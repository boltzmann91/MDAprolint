...
def calculate_optimal_cutoff(u, prot_sel, lip_sel, step=1, max_dist=15.0, bins=200, sigma=3.0):
    """
    ...
    Automatically saves the plot to a 'cutoffs/' directory.
    ...
    save_path = os.path.join(output_dir, f"{formatted_lip_name}_cutoff.png")
